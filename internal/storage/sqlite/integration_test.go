...
func TestSessionCRUD(t *testing.T) {
	...
	_, err = db.ExecContext(context.Background(), `CREATE TABLE IF NOT EXISTS sessions (id TEXT PRIMARY KEY, status TEXT, created_at TEXT, ended_at TEXT, participant_count INTEGER, template_id TEXT NOT NULL DEFAULT '', metadata TEXT, stt_profile TEXT NOT NULL DEFAULT '', llm_profile TEXT NOT NULL DEFAULT '')`)
	require.NoError(t, err)
