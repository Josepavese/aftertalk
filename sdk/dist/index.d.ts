...
declare class MinutesAPI {
    ...
    update(sessionId: string, request: UpdateMinutesRequest): Promise<Minutes>;
    getVersions(sessionId: string): Promise<MinutesVersion[]>;
