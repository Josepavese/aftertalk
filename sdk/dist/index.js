...
var ConfigAPI = class {
  ...
  async getRTCConfig() {
    return this.http.get("/v1/rtc-config");
  }
};
...
var MinutesAPI = class {
  ...
  async getBySession(sessionId) {
    return this.http.get(`/v1/sessions/${sessionId}/minutes`);
  }
  async update(sessionId, request) {
    return this.http.put(`/v1/sessions/${sessionId}/minutes`, request);
  }
  async getVersions(sessionId) {
    return this.http.get(`/v1/sessions/${sessionId}/minutes/versions`);
  }
...
exports.AftertalkClient = AftertalkClient;
exports.AftertalkError = AftertalkError;
exports.AudioManager = AudioManager;
exports.ConfigAPI = ConfigAPI;
exports.MinutesAPI = MinutesAPI;
exports.MinutesPoller = MinutesPoller;
exports.SessionsAPI = SessionsAPI;
exports.SignalingClient = SignalingClient;
exports.TranscriptionsAPI = TranscriptionsAPI;
